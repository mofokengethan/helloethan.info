...
<template>
  <section class="horizontalScroll">
    <h2 class="horizontalScroll-title">{{props.title}}</h2>
...
.horizontalScroll { margin-top: 24px; margin-bottom: 36px;}
.horizontalScroll-title { margin: 0 0 8px; font: 700 20px/1.2 system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial; letter-spacing: .2px; padding: 0 4px; text-align: start; justify-content: start; }
.horizontalRow { display: flex; gap: 14px; overflow-x: auto; -webkit-overflow-scrolling: touch; padding: 6px 4px 12px; scroll-snap-type: x mandatory; }
